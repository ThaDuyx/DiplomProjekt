...
struct StudentAbsenceInformationSection: View {
    ...
    var body: some View {
        VStack {
            ...
            StudentAbsencesSection(title: "reason".localize, icon: "questionmark.circle", description: reason)
            ...
            if let endDate = endDate {
                ...
                StudentAbsencesSection(title: "date".localize, icon: "calendar", description: dateCombined)
            } else {
                StudentAbsencesSection(title: "date".localize, icon: "calendar", description: DateFormatter.abbreviationDayMonthYearFormatter.string(from: date))
            }
